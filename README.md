...
Source code published in this repository is licensed under the [Apache License 2.0](LICENSE) (`Apache-2.0`). Component repositories, binary packages, models, and simulation assets may carry their own licenses; consult their distribution packages.
